                            ...
                            <form class="layui-form" onsubmit="return false">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        ...
                                        <input type="text" class="layui-input" id="name" placeholder="网点编号、负责人、网点">
                                    </div>
                                </div>
...
<script>
    ...
    layui.use(['index', 'table', 'form', 'common', 'http', 'tree', 'util'], function () {
        ...
        table.render({
            ...
            , method: 'post'
            , align: "right"
            , url: adminurl + "/crm/service_contract_search"//数据接口
            , where: {
                _token: _token,
                status: status,
            ...
            , cols: [[
                ...
                , {field: 'constract_expires', title: '合同期限'}
                , {field: 'audited_at', title: '审核时间'}
                , {field: 'constract_begin_at', title: '生效时间'}
                , {field: 'constract_end_at', title: '到期时间'}
                , {field: 'league', title: '加盟费'}
                , {field: 'bail', title: '保证金'}
                , {field: 'service_name', title: '网点',event: 'setSign',
