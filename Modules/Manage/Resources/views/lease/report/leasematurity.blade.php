...
<div class="layui-col-md12">
    <div class="layui-col-md12">
        ...
        <div class="layui-card">
            <div class="layui-card-header">到期转化图</div>
            <div class="layui-card-body">
                <div class="search-div">
                    <div class="layui-form" action="" style="float: right;width:800px;margin-top:10px;">
                        <div class="layui-inline">
                            <input type="text" class="layui-input" placeholder="开始时间 - 结束时间" autocomplete="off" id="datetimeclick"
                                   style="display: none">
                        </div>
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearch"
                                    id='search' onclick="load()"><i class="layui-icon"></i>搜索
                            </button>
                        </div>
                    </div>
                </div>
                <div class="div-mid" id="box"></div>
    ...
    <div class="layui-col-md12">
        <div class="layui-card">
            <div class="layui-card-header">到期转化统计表</div>
            <div class="layui-card-body">
                <div class="search-div">
                    <div class="layui-form" action="" style="float:right;margin-right:5px; ">
                        <div class="layui-inline">
                            <input type="text" class="layui-input" placeholder="开始时间 - 结束时间" autocomplete="off" id="datetimeclicktwo">
                        </div>
                        <div class="layui-inline" align="left">
                            <select lay-verify="required" lay-search="" id="areatwo"
                                    name="areatwo">
                                @foreach($provinces as $id=>$province)
                                    <option value="{{$id}}">{{$province}}</option>
                                @endforeach
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearchTwo"
                                    id='search2' onclick="load_table()"><i class="layui-icon"></i>搜索
                            </button>
                        </div>
                    </div>
...
<script src="{{asseturl("js/lease/report/leasematurity.js?".time())}}"></script>
</html>