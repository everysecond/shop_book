        ...
        <div class="layui-card-body" style="padding: 0;">
            <div class="layui-tab layui-tab-brief" lay-filter="component-tabs-brief">
                <ul class="layui-tab-title" style="border-bottom-color: #cccccc;margin: 0 15px;">
                    <li class="title-font layui-this" onclick="load_tab_1()">每小时注册</li>
                    <li class="title-font" onclick="load_tab_2()">累计每小时</li>
                    <li class="title-font" onclick="load_tab_3()">注册统计</li>
                </ul>
                <div class="layui-tab-content" style="padding: 0;">
                                    ...
                                    <div class="layui-form" style="float: right;">
                                        <div class="layui-form-item">
                                            <div class="layui-inline" align="right">
                                                <select name="register_hour_agents"
                                            ...
                                            <div class="layui-inline">
                                                <button class="layui-btn layui-btn-normal" lay-submit=""
                                                        lay-filter="formSearch" onclick="load_register_hour()"><i
                    ...
                    <div class="layui-tab-item" style="width:100%;height: 100%;">
                        <div class="layui-card-header title-font mar15">注册趋势</div>
                        <div class="layui-card-body">
                            <div class="layui-card-body">
                                <div class="search-div">
                                    <div class="layui-form" style="float: right;">
                        ...
                        <div class="layui-col-md6" style="padding: 0;">
                            <div class="layui-card" style="height: 600px;">
                                <div class="layui-card-header title-font">注册渠道</div>
                                <div class="search-div" style="height: 70px;">
                                    <div class="layui-form" style="float: right;">
                                        <div class="layui-form-item" style="margin-top: 20px;">
                                            ...
                                            <div class="layui-inline" align="left">
                                                <select name="register_from_agents" lay-verify="required" lay-search="">
                                                    @foreach($provinces as $id=>$province)
                                                        <option value="{{$id}}">{{$province}}</option>
                                                    @endforeach
                                                </select>
                        ...
                        <div class="layui-col-md6" style="padding: 0 0 0 10px;">
                            <div class="layui-card" style="height: 600px;">
                                <div class="layui-card-header title-font">注册统计</div>
                                <div class="layui-form" align="right" style="width:100%;margin-top: 20px;">
                                    <div class="layui-form-item">
                                        <div class="layui-inline">
                                            <div class="layui-input-inline">
                                        ...
                                        <div class="layui-inline" align="left">
                                            <select name="agentId3" lay-verify="required" lay-search="">
                                                @foreach($provinces2 as $id=>$province)
                                                    <option value="{{$id}}">{{$province}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div style="margin: 5px 10px 10px 10px;">
                                    <table id="table_register_total"></table>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="{{asseturl("js/lease/report/register_view.js?").time()}}"></script>
</body>
</html>
