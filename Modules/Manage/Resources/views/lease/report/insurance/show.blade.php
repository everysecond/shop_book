...
{{--                        <option value="0">全部区域</option>--}}
        ...
        <div id="box1" style="width:100%;height:450px;"></div>
    </div>
        ...
        <div class="layui-card">
            <div class="layui-form" align="right">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline" align="left">
                        <select name="modules" lay-verify="required" lay-search="" id='tes31' lay-filter="demo13">
                            @foreach($timeType as $item)
                                <option value="{{$item['id']}}">{{$item['name']}}</option>
                            @endforeach
                        </select>
...
<script src="{{asseturl("js/lease/report/insurance.js?").time()}}"></script>
</body>
</html>