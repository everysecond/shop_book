        ...
        <div class="layui-card-body" style="padding: 0;">
            <div class="layui-tab layui-tab-brief" lay-filter="component-tabs-brief">
                <ul class="layui-tab-title" style="border-bottom-color: #cccccc;margin: 0 15px;">
                    <li class="title-font layui-this" onclick="load_tab_1()">每小时转化</li>
                    <li class="title-font" onclick="load_tab_2()">累计每小时转化</li>
                    <li class="title-font" onclick="load_tab_3()">转化统计</li>
                </ul>
                <div class="layui-tab-content" style="padding: 0;">
                    <div class="layui-tab-item  layui-show">
                        <div class="layui-card-header title-font mar15">每小时转化数</div>
                        <div class="layui-card-body">
                            <div class="layui-card-body">
                                <div class="search-div">
                                    <div style="float: left" class="layui-form">
                                        <div class="layui-input-inline">
                                            <input type="text" class="layui-input" id="hour1" placeholder="选择对比日期" autocomplete="off">
                                        </div>
                        ...
                        <div class="layui-form" align="right" style="width:100%;margin-top:10px; margin-bottom:15px;">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <input type="text" class="layui-input" placeholder="日期" autocomplete="off"  id="date1" name="date1">
                                    </div>
                                </div>
                                <div class="layui-inline" align="left">
                                    <select name="agentId1"  id="agentId1"  lay-verify="required" lay-search="">
                                        @foreach($provinces as $id=>$province)
                                            <option value="{{$id}}">{{$province}}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="layui-tab-item" style="width:100%;">
                        <div class="layui-card-header title-font mar15">累计小时转化数</div>
                        <div class="layui-card-body">
                            <div class="layui-card-body">
                                <div class="search-div">
                                    <div style="float: left" class="layui-form">
                                        <div class="layui-input-inline">
                                            <input type="text" class="layui-input" id="hour2" placeholder="选择对比日期" autocomplete="off">
                                        </div>
                                    ...
                                    <div class="layui-form" style="float: right;">
                                        <div class="layui-form-item">
                                            <div class="layui-inline" align="right">
                                                <select name="register_hour_agents2"
                                                        lay-verify="required" lay-search="">
                                                    @foreach($provinces as $id=>$province)
                                                        <option value="{{$id}}">{{$province}}</option>
                                                    @endforeach
                                            ...
                                            <div class="layui-inline">
                                                <button class="layui-btn layui-btn-normal" lay-submit=""
                                                        lay-filter="formSearch" onclick="load_register_total()"><i
                                                            class="layui-icon"></i>搜索
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div style="width: 100%;border-top: 10px solid #f2f2f2"></div>
                        <div class="layui-card-header title-font mar15">累计转化统计表</div>
                        <div class="layui-form" align="right" style="width:100%;margin-top:10px;">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <input type="text" class="layui-input" placeholder="日期" autocomplete="off"  id="date2" name="date2">
                                    </div>
                                </div>
                                <div class="layui-inline" align="left">
                                ...
                                <div class="layui-inline">
                                    <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearch"
                                            onclick="load_hours_table()"><i class="layui-icon"></i>搜索
                                    </button>
                    ...
                    <div class="layui-tab-item" style="width:100%;">
                        <div class="layui-card-header title-font mar15">转化统计图</div>
                        <div class="layui-card-body">
                            <div class="layui-card-body">
                                <div class="search-div">
                                    <div class="layui-form" style="float: right;">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" class="layui-input" id="hour3" placeholder="选择日期" autocomplete="off">
                                            </div>
                                            <div class="layui-inline" align="right">
                                                <select name="register_hour_agents3"
                                                        lay-verify="required" lay-search="">
                                                    @foreach($provinces as $id=>$province)
                                                        <option value="{{$id}}">{{$province}}</option>
                                                    @endforeach
                                            ...
                                            <div class="layui-inline">
                                                <button class="layui-btn layui-btn-normal" lay-submit=""
                                                        lay-filter="formSearch" onclick="load_register_total3()"><i
                                                            class="layui-icon"></i>搜索
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="div-mid" id="load_register_total3_cum" style="margin-bottom: 15px"></div>
                            </div>
                        </div>
                        <div style="width: 100%;border-top: 10px solid #f2f2f2"></div>
                        <div class="layui-card-header title-font mar15">每日转化统计表</div>
                        <div class="layui-form" align="right" style="width:100%;margin-top:10px;">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <input type="text" class="layui-input" placeholder="日期范围" autocomplete="off" id="date3">
                                    </div>
                                </div>
                                <div class="layui-inline" align="left">
                                    <select name="total_agentId3" lay-verify="required" lay-search="">
                                        @foreach($provinces as $id=>$province)
                                            <option value="{{$id}}">{{$province}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <table id="table_total_day"></table>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{asseturl("js/lease/report/leaseregister.js?".time())}}"></script>
</html>