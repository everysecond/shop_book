...
<div class="layui-col-md12">
    <div class="layui-col-md6" style="padding: 0 5px 0 0">
        <div class="bg-white">
            <div class="layui-card-header title-font mar15">退回趋势</div>
    ...
    <div class="layui-col-md6" style="padding: 0 0 0 5px">
        <div class="bg-white">
            <div class="layui-card-header title-font mar15">退回分析</div>
            <div class="layui-card-body">
                <div class="layui-card-body">
                    <div class="search-div">
                        <div class="layui-form" align="right" style="margin-top:10px;">
    ...
    <div class="layui-col-md12" style="padding: 10px 0 0 0">
        <div class="bg-white">
            <div class="layui-card-header title-font mar15">退回统计表</div>
            <div class="layui-form" align="right" style="width:100%;margin-top:10px;">
                <div class="layui-form-item">
                    <div class="layui-inline" align="left">
                        <select name='num_type'>
                            <option value="1">退回申请数</option>
                            <option value="2">退回电池组数</option>
                        </select>
                    </div>
                    <div class="layui-inline">
...
<script src="{{asseturl("js/lease/service/return.js?").time()}}"></script>
</body>
</html>
