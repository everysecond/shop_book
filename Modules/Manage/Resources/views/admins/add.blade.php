        ...
        <div class="layui-col">
            <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="role_id" lay-verify="required"
                                    @if(isset($adminInfo->id) && $adminInfo->id==1) disabled @endif>
                ...
                <div class="layui-col-md6">
                    <div class="layui-form-item up-avator-box" style="display:none;">
                        <div class="layui-upload">
                            <div class="layui-upload-list up-avator-show">
                                ...
                                <img id="avator" class="layui-upload-img"
                                     src="@if(isset($adminInfo->avator)) {{url("storage/".$adminInfo->avator)}}@else {{url("resource/images/default.png")}} @endif">
                                <p id="demoText"></p>
                            </div>
                            <input id="avatorUpload" type="file" name="imgpath"
                                   onchange="uploadImage(this,'avator')" value="" style="display: none">
