...
@section('content')
    ...
    <div class="layui-form" lay-filter="form" id="form" style="padding: 20px 30px 0 0;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                {{Form::select('pid',$options,request('pid'))}}
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">归属终端</label>
            <div class="layui-input-inline">
                {{Form::select('terminal',['web'=>'WEB端','app'=>'移动端'],'web')}}
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                {{Form::select('target',['in'=>'Iframe内','_blank'=>'新窗口'],'in')}}
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="icon" id="icon" placeholder="请选择菜单图标" autocomplete="off" class="layui-input">
            </div>
    ...
    <script>
        ...
        layui.use(['index', 'form', 'http', 'common'], function () {
            ...
            form.on("submit(form-submit)", function (data) {
                http.post('{{route('manage-menu.store')}}', data.field).then(function (res) {
