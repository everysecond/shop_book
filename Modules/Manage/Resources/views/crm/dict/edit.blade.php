...
@section('content')
    ...
    <div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="dict_type" lay-verify="required" placeholder="字典类型" autocomplete="off"
                       class="layui-input" value="{{$model->dict_type}}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="type_means" lay-verify="required" placeholder="类型名称" autocomplete="off"
                       class="layui-input" value="{{$model->type_means}}">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="means" lay-verify="required" placeholder="值" autocomplete="off"
                       class="layui-input" value="{{$model->means}}">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="memo" placeholder="" autocomplete="off" class="layui-input" value="{{$model->memo}}">
            </div>
        </div>
    ...
    <script>
        ...
        layui.use(['jquery','index', 'form', 'http','common'], function () {
            ...
            form.on("submit(LAY-user-back-submit)", function (data) {
                http.put('{{route('dict.update',$model->id)}}', data.field).then(function (res) {
