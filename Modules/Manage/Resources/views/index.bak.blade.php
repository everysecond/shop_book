    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <cite>{{getAdminName()}}</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a lay-href="{{adminurl("/admins/profile")}}">基本资料</a></dd>
                        <dd><a lay-href="{{adminurl("/admins/repass")}}">修改密码</a></dd>
                        <hr>
                        <dd style="text-align: center;"><a class="loginout">退出</a></dd>
                    </dl>
                </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="manage/console" lay-attr="manage/console" class="layui-this"><i
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="manage/console" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
...
<script>
    ...
    layui.config({
        base: "{{asseturl("lib")}}" + '/layuiadmin/'   //静态资源所在路径 lib/layuiadmin/layui/css/layui.css")}}
    }).extend({
