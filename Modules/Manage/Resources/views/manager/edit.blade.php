...
@section('content')
    ...
    <div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="password" placeholder="请输入密码" class="layui-input" autocomplete="new-password"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="status" lay-skin="switch" lay-text="正常|冻结"
                value="1" {{$model->status?'checked':''}}>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">租点区域</label>
            <div class="layui-input-inline">
                {{Form::select('agent_id',$agents,$model->agent_id)}}
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                {{Form::select('site_id',$sites,$model->site_id)}}
            </div>
        </div>
    ...
    <script>
        ...
        layui.extend({
            ...
            form.on("submit(LAY-user-back-submit)", function (data) {
                ...
                http.put('{{route('manager.update',$model->id)}}', data.field).then(function () {
            ...
            //清除默认选中项
            var roles = eval('({!! $model->roles()->pluck('id') !!})');
