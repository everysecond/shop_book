...
class TerminalController extends Controller
{
    ...
    public function terminalView()
    {
        ...
        return view("manage::lease.service.user.terminal_chart", compact("timeType", 'channelArr'));
    }
    ...
    public function trend(Request $request)
    {
        try {
            ...
            $data = $this->model->trend($request, $defaultDay,BlAppDown::APP_TYPE_TWO);
            $numData = [];
    ...
    {
        try {
            $data = $this->model->getSortProfile($request,BlAppDown::APP_TYPE_TWO);
    ...
    {
        try {
            $balanceData = $this->model->getList($request,BlAppDown::APP_TYPE_TWO);
