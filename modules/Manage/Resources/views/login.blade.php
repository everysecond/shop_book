...
<head>
    ...
    <style>
        ...
        /*把整个屏幕真正撑开--而且能自己实现居中*/
        .main_content {
            background: url(/resource/images/main_bg.png) repeat;
            margin-left: auto;
            margin-right: auto;
            text-align: left;
            float: none;
...
<body style="background:url(/resource/images/bg2.jpg) no-repeat;">
...
<script src="/resource/js/manage/login.js?{{time()}}"></script>
</body>
</html>
