    ...
    <div class="layui-form" lay-filter="layuiadmin-form-admin" id="layuiadmin-form-admin"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="width: 276px;z-index: 55">
                {{Form::select("staff_id",$managers,"",["lay-verify","lay-search","placeholder"=>"请选择或输入搜索"])}}
                <input type="hidden" id="customer_id" value="{{request('ids')}}">
            </div>
        </div>
    ...
    <script>
        ...
        layui.use(['index', 'form', 'http', 'common'], function () {
            ...
            form.on("submit(LAY-user-back-submit)", function (data) {
                ...
                $.ajax({
                    type: 'POST',
                    data: {'staff_id': data.field.staff_id, 'ids': customer_id, '_token': _token},
                    url: '{{route("cus.move")}}',
