            ...
            <div class="layui-tab layui-tab-brief" lay-filter="component-tabs-brief">
                ...
                <div class="layui-tab-content" style="padding: 0; height: 100%;">
                    ...
                    <div class="layui-tab-item" style="width:100%;height:100%;">
                        <div class="layui-card-header title-font mar15">新用户租赁趋势</div>
                        <div class="layui-card-body">
                            <div class="layui-card-body">
                                <div class="search-div">
                                    <div class="layui-form" style="float: right;">
                        ...
                        <div style="width: 100%;border-top: 10px solid #f2f2f2"></div>
                        <div class="layui-card-header title-font mar15">新用户租赁统计表</div>
...
<script src="{{asseturl("js/lease/report/lease_new_view.js?").time()}}"></script>
</body>
</html>
