...
<div class="layui-col-md12">
    <div class="layui-col-md6">
        <div class="layui-card">
            <div class="layui-card-header">租赁趋势图</div>
            ...
            <div class="layui-card-body">
                <div class="layui-form search-div">
                    <div class="layui-form-item" style="float: right;">
                        <div class="layui-inline" style="width: 160px">
                            <input type="text" class="layui-input" placeholder="开始时间 - 结束时间"
                                   id="dateX" style="display: none" autocomplete="off">
                        </div>
                        <div class="layui-inline" align="left" style="width: 100px">
                            <select name="daysX" lay-verify="required" lay-search=""
                                    lay-filter="timeTypeX">
                                @foreach($timeType as $item)
                                    <option value="{{$item['id']}}">{{$item['name']}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearch"
                                    onclick="load_lease_area()"><i class="layui-icon"></i>搜索
                            </button>
                        </div>
                    </div>
                </div>
                <div class="div-mid" id="lease_area_chart"></div>
            </div>
        </div>
    </div>
    <div class="layui-col-md6">
        <div class="layui-card">
            <div class="layui-card-header">租赁周期分布</div>
            <div class="layui-card-body">
                <div class="layui-form search-div">
                    <div class="layui-form-item" style="float: right;">
                        <div class="layui-inline" style="width: 160px">
                            <input type="text" class="layui-input" placeholder="开始时间 - 结束时间"
                                   id="dateCycle" style="display: none" autocomplete="off">
                        </div>
                        <div class="layui-inline" align="left" style="width: 100px">
                            <select name="daysCycle" lay-verify="required" lay-search=""
                                    lay-filter="timeTypeCycle">
                                @foreach($timeType as $item)
                                    <option value="{{$item['id']}}">{{$item['name']}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearch"
                                    onclick="load_lease_cycle()"><i class="layui-icon"></i>搜索
                            </button>
                        </div>
                    </div>
                </div>
                <div class="div-mid" id="lease_cycle_chart"></div>
            </div>
        </div>
    </div>
    <div class="layui-col-md6">
        <div class="layui-card">
            <div class="layui-card-header">租赁单状态统计</div>
            <div class="layui-card-body">
                <div class="layui-form search-div">
                    <div class="layui-form-item" style="float: right;">
                        <div class="layui-inline" style="width: 160px">
                            <input type="text" class="layui-input" placeholder="开始时间 - 结束时间"
                                   id="dateStatus" style="display: none" autocomplete="off">
                        </div>
                        <div class="layui-inline" align="left" style="width: 100px">
                            <select name="daysStatus" lay-verify="required" lay-search=""
                                    lay-filter="timeTypeStatus">
                                @foreach($timeType as $item)
                                    <option value="{{$item['id']}}">{{$item['name']}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearch"
                                    onclick="load_status_area()"><i class="layui-icon"></i>搜索
                            </button>
                        </div>
                    </div>
                </div>
                <div class="div-mid" id="lease_status_chart"></div>
            </div>
        </div>
    </div>
    <div class="layui-col-md12">
...
<script src="{{asseturl("js/lease/report/lease_analysis.js?").time()}}"></script>
</body>
</html>
