        ...
        <div class="layui-card">
            <div class="layui-form" align="right">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline" align="left">
                        <select name="modules" lay-verify="required" lay-search="" id='tes3' lay-filter="demo13">
                            @foreach($timeType as $item)
                                <option value="{{$item['id']}}">{{$item['name']}}</option>
                            @endforeach
                        </select>
            ...
            <div id="box_term" style="width:100%;height:450px;"></div>
        </div>
    </div>
    <div class="layui-col-md6" align="center" >
        <div class="layui-card" style="padding: 20px;height: 478px">
            <div class="layui-form" align="right">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" id="test101" placeholder="开始时间 - 结束时间"
                                   autocomplete="off"
                            >
                        </div>
                    </div>
...
<script src="{{asseturl("js/lease/report/loss_battery.js?").time()}}"></script>
</body>
</html>