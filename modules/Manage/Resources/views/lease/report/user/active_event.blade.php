...
<div class="layui-col-md12">
    <div class="layui-card" style="margin-bottom:10px;">
        <div class="layui-card-header title-font mar15">活跃事件趋势</div>
    ...
    <div class="layui-card" style="margin-bottom:10px;">
        <div class="layui-card-header title-font mar15">活跃事件统计</div>
        <div class="layui-card-body">
            <div class="layui-card-body">
                <div class="search-div">
                    <div class="layui-form" style="float: right;">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" placeholder="开始时间 - 结束时间"
                                           autocomplete="off" id="date3" style="display: none">
                                </div>
                            </div>
                            <div class="layui-inline" align="left">
                                <select name="days3" lay-verify="required" lay-search=""
                            ...
                            <div class="layui-inline" align="left">
                                <select name="agentsId" lay-verify="required" lay-search="">
                                    @foreach($provinces as $id=>$province)
                                        <option value="{{$id}}">{{$province}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="layui-inline">
                                <button class="layui-btn layui-btn-normal" onclick="load_lease_time()"
                                        lay-filter="formSearch"><i class="layui-icon"></i>搜索
                                </button>
                            </div>
                        </div>
                ...
                <div class="div-mid" id="box_active_event" style="margin-bottom: 15px"></div>
            </div>
        </div>
    </div>
    <div class="layui-card">
        <div class="layui-card-header title-font mar15">活跃事件统计表</div>
...
<script src="{{asseturl("js/lease/report/user_active_event.js?").time()}}"></script>
</body>
</html>