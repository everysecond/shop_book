...
<div class="layui-col-md12">
    <div class="layui-card" style="margin-bottom:10px;">
        <div class="layui-card-header title-font mar15">登陆租赁趋势</div>
    ...
    <div class="layui-card" style="margin-bottom:10px;">
        <div class="layui-card-header title-font mar15">登陆租赁统计</div>
        <div class="layui-card-body">
            <div class="layui-card-body">
                <div class="search-div">
                    <div class="layui-form" style="float: right;">
    ...
    <div class="layui-card">
        <div class="layui-card-header title-font mar15">登陆租赁统计表</div>
...
<script src="{{asseturl("js/lease/report/active_event.js?").time()}}"></script>
</body>
</html>