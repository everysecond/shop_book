...
<div class="layui-col-md12">
    <div class="layui-col-md12">
        <div class="layui-card">
            <div class="layui-card-header">各区域网点收益分布</div>
            <div class="layui-card-body">
                <div class="layui-form search-div">
                    <div class="layui-form-item"  style="float: right;">
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="formSearch" onclick="load_box_stock()"><i class="layui-icon"></i>搜索
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="layui-col-md12">
        <div class="layui-card">
            <div class="layui-card-header">各区域网点收益统计</div>
...
<script src="{{asseturl("js/lease/service/income.js?").time()}}"></script>
</body>
</html>
